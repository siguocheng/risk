 ...
 * @author fallrain
 */
public class WYStringUtils extends org.apache.commons.lang3.StringUtils {
    ...
    public static boolean startWithAnyIgnoreCase(CharSequence str, CharSequence... prefixs) {
        ...
        for (CharSequence prefix : prefixs) {
            if (WYStringUtils.startsWithIgnoreCase(str, prefix)) {
                return true;
            }
        }
        return false;
    ...
    public static String joinComma(Iterable<?> iterable) {
        return WYStringUtils.join(iterable, SEPARATOR);
    }
    ...
    public static String joinComma(Object[] array) {
        return WYStringUtils.join(array, SEPARATOR);
    }
