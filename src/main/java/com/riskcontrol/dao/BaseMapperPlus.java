...
import com.riskcontrol.util.StreamUtils;
...
public interface BaseMapperPlus<T, V> extends BaseMapper<T> {
    ...
    default <C> C selectVoById(Serializable id, Class<C> voClass) {
        ...
        return WYObjectUtils.convert(obj, voClass);
    }
    ...
    default <C> List<C> selectVoByIds(Collection<? extends Serializable> idList, Class<C> voClass) {
        ...
        return WYObjectUtils.convert(list, voClass);
    }
    ...
    default <C, P extends IPage<C>> P selectVoPage(IPage<T> page, Wrapper<T> wrapper, Class<C> voClass) {
        ...
        voPage.setRecords(WYObjectUtils.convert(list, voClass));
        return (P) voPage;
    }
